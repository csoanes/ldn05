...
object RateSubmissionFlow {
    class Initiator(val rateSubmissionState: RateSubmissionState,
         ...
         */
        @Suspendable
        override fun call(): RateSubmissionFlowResult {
            ...
            try {
                ...
                val offerMessage = TransactionState(rateSubmissionState, notary)
                // Stage 2.
 ...
 */
sealed class RateSubmissionFlowResult {
    class Success(val message: String?): RateSubmissionFlowResult() {
        override fun toString(): String = "Success($message)"
    }

    class Failure(val message: String?): RateSubmissionFlowResult() {
